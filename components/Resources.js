        ...
        <Grid item xs={12} md={6}>
          <Card variant="outlined" sx={{ borderRadius: 2, boxShadow: 3, backgroundColor: '#ffebee', '&:hover': { boxShadow: 6 } }}>
            <CardContent>
              ...
              <Button onClick={() => navigate('/handbook')} variant="contained" color="secondary" sx={{ marginTop: 2 }}>
                Download Handbook
              </Button>
            </CardContent>
          </Card>
        ...
        <Grid item xs={12} md={6}>
          <Card variant="outlined" sx={{ borderRadius: 2, boxShadow: 3, backgroundColor: '#e8f5e9', '&:hover': { boxShadow: 6 } }}>
            <CardContent>
              ...
              <Button onClick={() => navigate('/training/:course')} variant="contained" color="secondary" sx={{ marginTop: 2 }}>
                Watch Videos Free Videos
              </Button>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          <Card variant="outlined" sx={{ borderRadius: 2, boxShadow: 3, backgroundColor: '#fff3e0', '&:hover': { boxShadow: 6 } }}>
            <CardContent>
              ...
              <Button onClick={() => navigate('/templates')} variant="contained" color="secondary" sx={{ marginTop: 2 }}>
                Download Templates
              </Button>
            </CardContent>
          </Card>
        ...
        <Grid item xs={12} md={6}>
          <Card variant="outlined" sx={{ borderRadius: 2, boxShadow: 3, backgroundColor: '#e3f2fd', '&:hover': { boxShadow: 6 } }}>
            <CardContent>
              ...
              <Button onClick={() => navigate('/FAQPage')} variant="contained" color="secondary" sx={{ marginTop: 2 }}>
                View FAQs
              </Button>
            </CardContent>
          </Card>
